...
sys_env_destroy(envid_t envid)
{
  ...
  800117:	68 ca 1d 80 00       	push   $0x801dca
  80011c:	6a 23                	push   $0x23
  80011e:	68 e7 1d 80 00       	push   $0x801de7
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800198:	68 ca 1d 80 00       	push   $0x801dca
  80019d:	6a 23                	push   $0x23
  80019f:	68 e7 1d 80 00       	push   $0x801de7
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001da:	68 ca 1d 80 00       	push   $0x801dca
  8001df:	6a 23                	push   $0x23
  8001e1:	68 e7 1d 80 00       	push   $0x801de7
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80021c:	68 ca 1d 80 00       	push   $0x801dca
  800221:	6a 23                	push   $0x23
  800223:	68 e7 1d 80 00       	push   $0x801de7
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80025e:	68 ca 1d 80 00       	push   $0x801dca
  800263:	6a 23                	push   $0x23
  800265:	68 e7 1d 80 00       	push   $0x801de7
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002a0:	68 ca 1d 80 00       	push   $0x801dca
  8002a5:	6a 23                	push   $0x23
  8002a7:	68 e7 1d 80 00       	push   $0x801de7
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e2:	68 ca 1d 80 00       	push   $0x801dca
  8002e7:	6a 23                	push   $0x23
  8002e9:	68 e7 1d 80 00       	push   $0x801de7
...
sys_ipc_recv(void *dstva)
{
  ...
  800346:	68 ca 1d 80 00       	push   $0x801dca
  80034b:	6a 23                	push   $0x23
  80034d:	68 e7 1d 80 00       	push   $0x801de7
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80044e:	51                   	push   %ecx
  80044f:	50                   	push   %eax
  800450:	68 f8 1d 80 00       	push   $0x801df8
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800819:	53                   	push   %ebx
  80081a:	50                   	push   %eax
  80081b:	68 18 1e 80 00       	push   $0x801e18
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b53:	68 b7 1e 80 00       	push   $0x801eb7
  800b58:	53                   	push   %ebx
...
00800bb3 <_pipeisclosed>:
{
  ...
  800bf6:	50                   	push   %eax
  800bf7:	53                   	push   %ebx
  800bf8:	68 be 1e 80 00       	push   $0x801ebe
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e98:	68 d6 1e 80 00       	push   $0x801ed6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801021:	56                   	push   %esi
  801022:	50                   	push   %eax
  801023:	68 e4 1e 80 00       	push   $0x801ee4
  ...
  801034:	e8 56 00 00 00       	call   80108f <vcprintf>
	cprintf("\n");
  801039:	c7 04 24 cf 1e 80 00 	movl   $0x801ecf,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801189:	0f be 80 07 1f 80 00 	movsbl 0x801f07(%eax),%eax
  801190:	50                   	push   %eax
...
008011dd <vprintfmt>:
{
  ...
  801300:	52                   	push   %edx
  801301:	68 9d 1e 80 00       	push   $0x801e9d
  801306:	53                   	push   %ebx
  801307:	56                   	push   %esi
  ...
  801318:	50                   	push   %eax
  801319:	68 1f 1f 80 00       	push   $0x801f1f
  80131e:	53                   	push   %ebx
  80131f:	56                   	push   %esi
  ...
  801340:	b8 18 1f 80 00       	mov    $0x801f18,%eax
