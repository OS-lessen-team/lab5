	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ec:	0f be 80 e8 1d 80 00 	movsbl 0x801de8(%eax),%eax
  8001f3:	50                   	push   %eax
...
00800240 <vprintfmt>:
{
  ...
  80028c:	ff 24 85 20 1f 80 00 	jmp    *0x801f20(,%eax,4)
  ...
  800358:	8b 14 85 80 20 80 00 	mov    0x802080(,%eax,4),%edx
  80035f:	85 d2                	test   %edx,%edx
  800361:	74 18                	je     80037b <vprintfmt+0x13b>
				printfmt(putch, putdat, "%s", p);
  800363:	52                   	push   %edx
  800364:	68 b1 21 80 00       	push   $0x8021b1
  800369:	53                   	push   %ebx
  80036a:	56                   	push   %esi
  ...
  80037b:	50                   	push   %eax
  80037c:	68 00 1e 80 00       	push   $0x801e00
  800381:	53                   	push   %ebx
  800382:	56                   	push   %esi
  ...
  8003a3:	b8 f9 1d 80 00       	mov    $0x801df9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800b0c:	68 df 20 80 00       	push   $0x8020df
  800b11:	6a 23                	push   $0x23
  800b13:	68 fc 20 80 00       	push   $0x8020fc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b8d:	68 df 20 80 00       	push   $0x8020df
  800b92:	6a 23                	push   $0x23
  800b94:	68 fc 20 80 00       	push   $0x8020fc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bcf:	68 df 20 80 00       	push   $0x8020df
  800bd4:	6a 23                	push   $0x23
  800bd6:	68 fc 20 80 00       	push   $0x8020fc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c11:	68 df 20 80 00       	push   $0x8020df
  800c16:	6a 23                	push   $0x23
  800c18:	68 fc 20 80 00       	push   $0x8020fc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c53:	68 df 20 80 00       	push   $0x8020df
  800c58:	6a 23                	push   $0x23
  800c5a:	68 fc 20 80 00       	push   $0x8020fc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c95:	68 df 20 80 00       	push   $0x8020df
  800c9a:	6a 23                	push   $0x23
  800c9c:	68 fc 20 80 00       	push   $0x8020fc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cd7:	68 df 20 80 00       	push   $0x8020df
  800cdc:	6a 23                	push   $0x23
  800cde:	68 fc 20 80 00       	push   $0x8020fc
...
sys_ipc_recv(void *dstva)
{
  ...
  800d3b:	68 df 20 80 00       	push   $0x8020df
  800d40:	6a 23                	push   $0x23
  800d42:	68 fc 20 80 00       	push   $0x8020fc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e21:	ba 88 21 80 00       	mov    $0x802188,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800e43:	51                   	push   %ecx
  800e44:	50                   	push   %eax
  800e45:	68 0c 21 80 00       	push   $0x80210c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80109d:	53                   	push   %ebx
  80109e:	50                   	push   %eax
  80109f:	68 4d 21 80 00       	push   $0x80214d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801166:	53                   	push   %ebx
  801167:	50                   	push   %eax
  801168:	68 69 21 80 00       	push   $0x802169
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80120e:	53                   	push   %ebx
  80120f:	50                   	push   %eax
  801210:	68 2c 21 80 00       	push   $0x80212c
...
00801409 <devfile_read>:
{
  ...
  80145e:	c3                   	ret    
	assert(r <= n);
  80145f:	68 98 21 80 00       	push   $0x802198
  801464:	68 9f 21 80 00       	push   $0x80219f
  801469:	6a 7c                	push   $0x7c
  80146b:	68 b4 21 80 00       	push   $0x8021b4
  801470:	e8 85 05 00 00       	call   8019fa <_panic>
	assert(r <= PGSIZE);
  801475:	68 bf 21 80 00       	push   $0x8021bf
  80147a:	68 9f 21 80 00       	push   $0x80219f
  80147f:	6a 7d                	push   $0x7d
  801481:	68 b4 21 80 00       	push   $0x8021b4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801548:	68 cb 21 80 00       	push   $0x8021cb
  80154d:	53                   	push   %ebx
...
008015a8 <_pipeisclosed>:
{
  ...
  8015eb:	50                   	push   %eax
  8015ec:	53                   	push   %ebx
  8015ed:	68 d2 21 80 00       	push   $0x8021d2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80188d:	68 ea 21 80 00       	push   $0x8021ea
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a16:	56                   	push   %esi
  801a17:	50                   	push   %eax
  801a18:	68 f8 21 80 00       	push   $0x8021f8
  ...
  801a29:	e8 c4 e6 ff ff       	call   8000f2 <vcprintf>
	cprintf("\n");
  801a2e:	c7 04 24 dc 1d 80 00 	movl   $0x801ddc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801adf:	eb e2                	jmp    801ac3 <ipc_send+0x1c>
		if (ret != -E_IPC_NOT_RECV) panic("not E_IPC_NOT_RECV, %e", ret);
  801ae1:	50                   	push   %eax
  801ae2:	68 1c 22 80 00       	push   $0x80221c
  801ae7:	6a 36                	push   $0x36
  801ae9:	68 33 22 80 00       	push   $0x802233
