...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(faultio) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 e6 23 80 00       	push   $0x8023e6
  80006f:	6a 09                	push   $0x9
  800071:	68 00 24 80 00       	push   $0x802400
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025f:	0f be 80 43 24 80 00 	movsbl 0x802443(%eax),%eax
  800266:	50                   	push   %eax
...
008002b3 <vprintfmt>:
{
  ...
  8003ee:	50                   	push   %eax
  8003ef:	68 5b 24 80 00       	push   $0x80245b
  8003f4:	53                   	push   %ebx
  8003f5:	56                   	push   %esi
  ...
  800416:	b8 54 24 80 00       	mov    $0x802454,%eax
